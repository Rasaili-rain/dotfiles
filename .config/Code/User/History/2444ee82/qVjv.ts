...
export const getItemsByDheetoId = async (dheetoId: string): Promise<GetItemsByDheetoIdResponse> => {
...
export const getTransactionsByDheetoId = async (dheetoId: string): Promise<GetTransactionsByDheetoIdResponse> => {
