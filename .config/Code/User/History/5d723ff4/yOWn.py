#!/usr/bin/env python3
"""
Convert presentations and documents to PDF format.
Supports: PPTX, PPT, ODP, TXT, MD, RTF, DOC, DOCX
Usage: python convert_to_pdf.py <source_folder> [destination_folder]
"""
...
def find_files(folder_path: Path, extensions: List[str]) -> List[Path]:
    """Recursively find all files with given extensions in all subdirectories."""
    files = []
    for ext in extensions:
        # rglob with ** pattern searches all subdirectories recursively
