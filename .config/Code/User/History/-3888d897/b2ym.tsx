          ...
          {dheeto.items.length === 0 ? (
            ...
            <View className="gap-2">
              {dheeto.items.map((item) => (
                <View
                  key={item._id}
                  className={`rounded-lg p-4 border ${item.type === "gold"
            ...
            <>
              <View className="gap-2 mb-3">
                {dheeto.transactions.map((transaction) => (
                  <View
                    key={transaction._id}
                    className={`rounded-lg p-4 border ${transaction.type === "gave"
                    ...
                    <View className="flex-row items-start justify-between mb-3">
                      <View className="flex-1 pr-3">
                        <View className="flex-row items-center gap-2 mb-1">
                          <View
                            className={`px-2 py-0.5 rounded ${transaction.type === "gave" ? "bg-red-100" : "bg-green-100"
                              }`}
                          >
                            <Text
                              className={`text-xs font-semibold ${transaction.type === "gave" ? "text-red-700" : "text-green-700"
                                }`}
                            >
