...
export type GetItemsByDheetoIdResponse = PaginatedResponse<Item> | ErrorResponse;
...
export type GetTransactionsByDheetoIdResponse = PaginatedResponse<Transaction> | ErrorResponse;
